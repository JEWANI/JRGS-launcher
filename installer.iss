...
LicenseFile=
OutputDir=output
OutputBaseFilename=JRGS_{#MyAppVersion}_setup
SetupIconFile=dist\JRGS\ICON\JRGS.ico
...
[Files]
; 메인 실행파일 및 의존성
Source: "dist\JRGS\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
